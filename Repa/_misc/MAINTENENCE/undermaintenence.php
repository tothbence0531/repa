...
<head>
    ...
    <title>repa | Hoppá</title>
     ...
     <link rel="stylesheet" href="css/undermaintenence.css">
...
<body>
    ...
    <div class="wrapper">
        <h1 id="header">Ez az oldal jelenleg nem elérhető, gyere vissza később!</h1>
        <img src="img/construction.webp" alt="construction" id="construction">
    </div>
