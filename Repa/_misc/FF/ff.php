...
<head>
    ...
    <title>repa | Felhasználási feltételek</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h2>1. Bevezető</h2>
        <p>Üdvözöljük webshopunkban, ahol friss, természetes répákat kínálunk. Kérjük, olvassa el figyelemesen a Felhasználási Feltételeinket vásárlás előtt.</p>

        <h2>2. Szolgáltatásaink használata</h2>
