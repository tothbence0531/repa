...
<body>
    ...
    <main class="wrapper">
        <?php 
        /**
         * kommentek beillesztese
         * blueprint: /forum/php/comment.php
         */
        $datas = mysqli_query($conn, "SELECT * FROM forum WHERE 1");
            foreach ($datas as $data) {
                require "php/comment.php";
            }
        ?>
        <form class="comment-input-area" method="POST" action="php/forum.inc.php">
            <textarea name="commentText" id="commentInput" placeholder="Ide írd az üzeneted..."></textarea>
