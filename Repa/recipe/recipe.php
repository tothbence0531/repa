...
<head>
    ...
    <title>repa | Nagyi titkos receptjei</title>
</head>
<body>
    ...
    <div id="pic">
        <h1 id="title">Répás receptek a Nagyi jóvoltából</h1>
    </div>

    <br>

    <h1 class="head">Levesek</h1>
    <div class="row">
        <?php 
        /**
         * levesek beillesztese
         * blueprint: /recipe/php/recipe.inc.php
         */
        $datas = mysqli_query($conn, "SELECT * FROM `recipes` WHERE `type` = 'leves';");
        foreach ($datas as $data) {
            require "php/recipe.inc.php";
        }
        ?>

    </div>

    <h1 class="head">Főételek</h1>
    <div class="row">
        <?php 
        /**
         * foetelek beillesztese
         * blueprint: /recipe/php/recipe.inc.php
         */
        $datas = mysqli_query($conn, "SELECT * FROM `recipes` WHERE `type` = 'foetel';");
        foreach ($datas as $data) {
            require "php/recipe.inc.php";
        }
        ?>
    ...
    <h1 class="head">Desszertek</h1>
    <div class="row">
        <?php 
        /**
         * desszertek beillesztese
         * blueprint: /recipe/php/recipe.inc.php
         */
        $datas = mysqli_query($conn, "SELECT * FROM `recipes` WHERE `type` = 'desszert';");
        foreach ($datas as $data) {
            require "php/recipe.inc.php";
        }
        ?>
