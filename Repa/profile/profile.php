<?php
    session_start();
    // csak akkor latogathatja az oldalt a user ha be van jelentkezve
...
<head>
    ...
    <script src="js/changeTel.js"></script>
...
<body>
    ...
    <div id="border">
        <div id="picture-side">
            <div id="picture">
                <?php
                // profilkep megjelenitese
                if($_SESSION['pfp'] === "") $pfp = "defprof.jpg";
                else $pfp = $_SESSION['pfp'];
                 echo '<img id="avatar" src="../_rootprofpics/'.$pfp.'" alt="Avatar">'; ?>
                
            </div>

            <!-- PROFILE PICTURE UPLOAD -->

            <form action="php/upload.inc.php" method="post" class="picupload-form" enctype="multipart/form-data">
                <label  id="upload">
                    Kiválasztás
                    <input type="file" name="file">
                </label>
                <button class="picupload-submit" name="uploadpfp" type="submit"><svg xmlns='http://www.w3.org/2000/svg' height='24' viewBox='0 -960 960 960' width='24'><path d='M120-160v-640l760 320-760 320Zm80-120 474-200-474-200v140l240 60-240 60v140Zm0 0v-400 400Z'/></svg></button>
            </form>

            <?php
            // admin felulet gomb megjelenitese, ha admin a user
            if ($_SESSION["admin"] === 1) {
                echo'<a href="../admin/admin.php" id="admin">Admin felület</a>';
            }
        ...
        <div id="info-side">
            <div class="info">
                <div id="edit">
                    <a href="php/logout.inc.php" class="logoutButton"><svg class="logoutSvg" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h280v80H200v560h280v80H200Zm440-160-55-58 102-102H360v-80h327L585-622l55-58 200 200-200 200Z"/></svg></a>
                    <h5>Becenév</h5>
                    <button onclick="changeName()" id="change"><svg id="edit-button" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M200-200h57l391-391-57-57-391 391v57Zm-80 80v-170l528-527q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L290-120H120Zm640-584-56-56 56 56Zm-141 85-28-29 57 57-29-28Z"/></svg></button>
                </div>
                <?php
                    
                    echo "<p id=nickname>" . ($_SESSION["usernick"]) . "</p>";
                ?>
                <form id="submit" method="POST" action="php/profile.inc.php">
                    <input type="text" id="changeName" name="changeName">
                    <button onclick="saveName()" id="saveName" name="saveName">Submit</button>
                </form>
            </div>
            <hr>
            <div class="info">
            ...
            <div id="editTel">
                    <h5>Telefonszám</h5>
                    <button onclick="changeTel()" id="changeTelBtn"><svg id="edit-button-tel" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M200-200h57l391-391-57-57-391 391v57Zm-80 80v-170l528-527q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L290-120H120Zm640-584-56-56 56 56Zm-141 85-28-29 57 57-29-28Z"/></svg></button>
                </div>
                <?php
                    
                    echo "<p id=tel>" . ($_SESSION["usertel"]) . "</p>";
                ?>
                <form id="submitTel" method="POST" action="php/profile.inc.php">
                    <input type="text" id="changeTel" name="changeTel">
                    <button onclick="saveTel()" id="saveTel" name="saveTel">Submit</button>
                </form>
            </div>
        </div>
    </div>
