...
<head>
    ...
    <title>repa | Az ország legjobb répa boltja</title>
...
<body>
    ...
    <section class="welcome-wrapper">
        <h1>Üdvözlünk a repa weboldalán!</h1>
        <img src="index/img/bannerlogo2.png" alt="welcome">
    </section>
    ...
    <!-- STORE BANNER -->
     ...
     <section class="wrapper">
        <div class="text">
            <h1>Minden nap friss répa!</h1>
            <p>Célunk, hogy mindig legyen friss répa az asztalon, vásárolj az ország legkiválóbb termelőitől!</p>
            <a href="shopfront/shopfront.php">Vásárolj most!</a>
        </div>
        <div class="banner-img">
            <img src="index/img/store_banner.webp" alt="banner">
        </div>
     </section>
     ...
     <div class="recipes-wrapper">
        <h3>Nagyi titkos répás receptjei</h3>
        <h2>A legjobb recepteket itt találod</h2>
        <div class="recipes">
            <article class="recipes-img-div">
                <div>
                    <img src="index/img/carrot-salad.jpg" alt="salata">
                </div>
                <div>
                    <h3>Répa főétel</h3>
                    <p>Finom és frissítő reszelt sárgarápa saláta csak 5 egyszerű összetevőből</p>
                    <a href="recipe/recipe.php">Receptekhez</a>
                </div>
            </article>
            <article class="recipes-img-div">
                <div>
                    <img src="index/img/carrot-cake.jpg" alt="torta">
                </div>
                <div>
                    <h3>Répa desszert</h3>
                    <p>Puha, enyhe ízesítésű, ez a klasszikus sárgarépa torta tökéletes bármilyen ünnepségre!</p>
                    <a href="recipe/recipe.php">Receptekhez</a>
                </div>
            </article>
            <article class="recipes-img-div"> 
                <div>
                    <img src="index/img/carrot-soup.jpg" alt="leves">
                </div>
                <div>
                    <h3>Répa leves</h3>
                    <p>Ebben a krémes sárgarépa levesben nem találsz diót vagy tejterméket. Maguk a sárgarépák adják meg az ízletes textúrát!</p>
                    <a href="recipe/recipe.php">Receptekhez</a>
                </div>
            </article>
         </div>
     ...
     <section class="wrapper" id="forum-wrapper">
        <div class="banner-img" id="forum-img">
            <img src="index/img/forum.png" alt="forum">
        </div>
        <div class="text">
            <h1>Befogadó közösség</h1>
            <p>Beszélgess barátkozz, hagyj kommentet az oldallal kapcsolatban, minden véleményre kíváncsiak vagyunk!</p>
            <a href="forum/forum.php">Fejtsd ki a véleményed!</a>
        </div>
     </section>
     ...
     <div class="recipes-wrapper">
        <h3>Repa kollekció</h3>
        <h2>Mostantól elérhető a repa kollekció!</h2>
        <div class="recipes">
            <article class="recipes-img-div">
                <div>
                    <img src="admin/img/logotshirt.jpg" class="merch" alt="polo">
                </div>
                <div>
                    <h3>Pólók</h3>
                    <p>Választható minták, méretek</p>
                    <a href="merch/merch.php">Vigyél oda!</a>
                </div>
            </article>
            <article class="recipes-img-div">
                <div>
                    <img src="admin/img/illustrationhoodie.jpg" class="merch" alt="pulcsi">
                </div>
                <div>
                    <h3>Pulcsik</h3>
                    <p>Választható minták, méretek</p>
            ...
            <article class="recipes-img-div"> 
                <div>
                    <img src="admin/img/illustrationbag.jpg" class="merch" alt="zacsko">
                </div>
                <div>
                    <h3>Genyók</h3>
                    <p>Választható minták, méretek</p>
